...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-[1.5rem] border border-slate-200/80 py-5 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur-xl",
        className
      )}
      {...props}
    />
