...
import {
  ...
  updateShiftAudit,
  deleteShiftAudit
} from '../controllers/shiftAuditController.js';
...
router.patch(
  '/module2/pricing-rules/:id/toggle',
  togglePricingRule
);

router.post(
  '/module2/pricing/recalculate',
  recalculatePricing
);

router.post(
  '/module2/pricing-engine/recalculate',
  recalculatePricing
);

router.get(
  '/module2/pricing-history',
  listPricingHistory
);
